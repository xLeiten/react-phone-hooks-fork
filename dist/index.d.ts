...
export declare const usePhone: ({ query, country, countryCode, initialValue, onlyCountries, excludeCountries, preferredCountries, disableParentheses, }: usePhoneOptions) => {
    value: string;
    pattern: string;
